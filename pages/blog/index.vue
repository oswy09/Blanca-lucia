...
<template>
  <div class="blog-page">
      ...
      <div class="wrap">
        <div class="blog-hero-inner reveal">
          ...
          <p class="blog-hero-desc">
            Practical perspectives from over 30 years working with Spanish-speaking professionals.
          </p>
        </div>
      </div>
    </section>
    ...
    <section v-if="featured" class="blog-featured-section">
      <div class="wrap">
        <NuxtLink :to="`/blog/${featured.slug}`" class="blog-featured-card">
          <div class="bfc-image">
    ...
    <section class="blog-grid-section">
      <div class="wrap">
        <h2 class="blog-section-label">All articles</h2>
...
/* ── Hero ───────────────────────────────────── */
.blog-hero {
  padding-block: clamp(64px, 10vw, 100px) clamp(48px, 7vw, 72px);
  background: linear-gradient(160deg, var(--teal-t1) 0%, var(--bg) 70%);
